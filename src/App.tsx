              ...
              <div className="lg:col-span-9 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[500px]">
                ...
                {editorTab === 'eleve' && (
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-bold text-slate-900 text-base">Renseignements de l'Élève</h4>
                      <p className="text-xs text-slate-500">Section 1 de la fiche d'inscription. Saisissez l'identité complète de l'élève.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-slate-600 uppercase">Prénoms (souligner l'usuel)</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-slate-600 uppercase">Pays de Naissance</label>
                        <input
                          type="text"
                          value={currentRecord.eleve.paysNaissance}
                          onChange={(e) => updateCurrentRecordField('eleve', 'paysNaissance', e.target.value)}
                          placeholder="France"
                          className="border border-slate-200 px-3.5 py-2.5 rounded-xl text-xs font-medium focus:outline-blue-500 bg-slate-50/50"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-slate-600 uppercase">Classe Actuelle</label>
                        <input
                          type="text"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-slate-600 uppercase">Enseignant(e)</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-bold text-slate-600 uppercase">École Fréquentée l'An passé</label>
                        <input
                          type="text"
                          value={currentRecord.eleve.ecolePrecedente}
                          onChange={(e) => updateCurrentRecordField('eleve', 'ecolePrecedente', e.target.value)}
                          placeholder="École Maternelle du Centre"
                          className="border border-slate-200 px-3.5 py-2.5 rounded-xl text-xs font-medium focus:outline-blue-500 bg-slate-50/50"
                        />
                      </div>
                      <div className="flex flex-col gap-1.5">
                ...
                {editorTab === 'medical' && (
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="flex items-center gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200/30">
                      <span className="text-xs font-bold text-slate-600 uppercase">Traitement nécessitant un protocole d'accueil individualisé (P.A.I.) ?</span>
                      <div className="flex items-center gap-4">
                        <label className="flex items-center gap-1.5 text-xs font-bold text-slate-700 cursor-pointer">
                          <input
                            type="radio"
                    ...
                    {currentRecord.personnesAutorisees.length > 0 ? (
                      <div className="space-y-4">
                        {currentRecord.personnesAutorisees.map((person, pIdx) => (
                          <div key={person.id} className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end bg-slate-50 p-4 rounded-xl border">
                            <div className="md:col-span-5 flex flex-col gap-1">
                              <label className="text-[10px] font-bold text-slate-500 uppercase">Nom & Prénom</label>
                              <input
                                type="text"
                    ...
                    <div className="border border-slate-200 p-4.5 rounded-2xl space-y-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <input
                          ...
                          className="border px-3.5 py-2.5 rounded-xl text-xs bg-white focus:outline-blue-500 w-44"
                        />
                      </div>
                    </div>
                  </div>
